...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'slug' => ['type' => 'string', 'length' => 191, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2020-07-28 08:55:23',
                'modified' => '2020-07-28 08:55:23',
            ],
        ];
        parent::init();
    }
